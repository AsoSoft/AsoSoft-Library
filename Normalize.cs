...
namespace AsoSoftLibrary
{
    public static partial class AsoSoft
    {
	   ...
	   static Dictionary<char, string> DeepReplacements = LoadNormalizerReplaces(replaceFiles.NormalizerDeep);
	   static Dictionary<char, string> additionalReplacements = LoadNormalizerReplaces(replaceFiles.NormalizerAdditional);
	   ...
	   private static Dictionary<char, string> LoadNormalizerReplaces(string file)
	   {
		  ...
		  foreach (var item in file.Trim().Split('\n'))
		  {
